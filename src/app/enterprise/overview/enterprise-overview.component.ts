...
@Component({
  ...
  template: `
    <div class="space-y-8 animate-in fade-in duration-500 text-slate-900">
      ...
      <div class="relative overflow-hidden rounded-2xl p-6 sm:p-8 bg-white border border-slate-200 shadow-xs">
        ...
        <div class="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
            ...
            <div class="flex items-center p-1 rounded-xl border bg-slate-100 border-slate-200">
              <button
                *ngFor="let r of ranges"
                ...
                class="px-3.5 py-1.5 rounded-lg text-xs font-bold transition-all text-slate-600 hover:text-slate-900 border border-transparent"
              >
                {{ r.label }}
              </button>
            </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <!-- Card 1: Total Volume -->
        <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs relative overflow-hidden transition-shadow hover:shadow-md group">
          <div class="flex items-center justify-between">
            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-indigo-600 bg-indigo-50 border border-indigo-100 group-hover:scale-105 transition-transform">
              <i class="fa-solid fa-money-bill-trend-up text-lg"></i>
            </div>
            <span class="text-[10px] font-bold uppercase tracking-wider px-2.5 py-1 rounded-full bg-indigo-50 text-indigo-700 border border-indigo-200">
              {{ rangeLabel() }}
            </span>
          </div>
          ...
          <div class="flex items-center justify-between text-xs mt-2.5 font-medium">
            <span class="text-indigo-600 font-semibold flex items-center gap-1"><i class="fa-solid fa-arrow-trend-up text-[10px]"></i> Live telemetry</span>
            <span class="text-slate-500">{{ analytics?.total_transactions || 0 }} TXs</span>
          </div>
        </div>
        ...
        <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs relative overflow-hidden transition-shadow hover:shadow-md group">
          <div class="flex items-center justify-between">
            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-emerald-600 bg-emerald-50 border border-emerald-100 group-hover:scale-105 transition-transform">
              <i class="fa-solid fa-wallet text-lg"></i>
            </div>
            <a routerLink="/api-keys" class="text-[10px] font-bold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 hover:bg-emerald-100 transition-colors">
              Manage Keys →
            </a>
          </div>
          ...
          <div class="flex items-center justify-between text-xs mt-2.5 font-medium text-slate-500">
            <span>Net Earnings + Top-ups</span>
            <span class="text-emerald-600 font-bold">Active Float</span>
          </div>
        </div>
        ...
        <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs relative overflow-hidden transition-shadow hover:shadow-md group">
          <div class="flex items-center justify-between">
            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-blue-600 bg-blue-50 border border-blue-100 group-hover:scale-105 transition-transform">
          ...
          <div class="flex items-center justify-between text-xs mt-2.5 font-medium text-slate-500">
            <span>Approved: <strong class="text-blue-600 font-bold">{{ analytics?.successful_transactions || 0 }}</strong></span>
        ...
        <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs relative overflow-hidden transition-shadow hover:shadow-md group">
          <div class="flex items-center justify-between">
            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-purple-600 bg-purple-50 border border-purple-100 group-hover:scale-105 transition-transform">
          ...
          <h3 class="text-2xl sm:text-3xl font-extrabold mt-1 text-purple-600 tracking-tight">
          ...
          <div class="flex items-center justify-between text-xs mt-2.5 font-medium text-slate-500">
            <span>PIN Confirmation Pop-ups</span>
            <span class="text-purple-600 font-bold">Optimal</span>
          </div>
        </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
          <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-6">
            ...
            <div class="flex items-center gap-4 text-xs font-bold">
              <span class="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-indigo-50 border border-indigo-200 text-indigo-700">
                <span class="w-2.5 h-2.5 rounded-full bg-indigo-600"></span> Processed Volume
              </span>
              <span class="flex items-center gap-2 px-2.5 py-1 rounded-lg bg-emerald-50 border border-emerald-200 text-emerald-700">
                <span class="w-2.5 h-2.5 rounded-full bg-emerald-500"></span> Net Revenue
              </span>
            </div>
          </div>
        ...
        <div class="p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
          ...
          <!-- Styled Legend Grid -->
          <div class="grid grid-cols-2 gap-2 text-xs font-bold pt-4 border-t border-slate-200">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div class="space-y-3">
            <div class="p-3.5 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between text-xs">
              <div class="flex items-center gap-2.5">
                ...
                <span class="text-slate-700 font-medium">API Telemetry Latency</span>
              </div>
              <span class="font-mono font-bold text-emerald-700">124 ms (Optimal)</span>
            </div>

            <div class="p-3.5 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between text-xs">
              <div class="flex items-center gap-2.5">
                <i class="fa-solid fa-network-wired text-blue-600"></i>
                <span class="text-slate-700 font-medium">Webhook Dispatch SLA</span>
              </div>
              <span class="font-mono font-bold text-blue-700">99.9% Success</span>
            </div>

            <div class="p-3.5 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between text-xs">
              <div class="flex items-center gap-2.5">
                <i class="fa-solid fa-key text-amber-600"></i>
                <span class="text-slate-700 font-medium">Active API Credentials</span>
              </div>
              <span class="font-mono font-bold text-amber-700">Active Keys</span>
            </div>

            <div class="p-3.5 rounded-xl border border-slate-200 bg-slate-50 flex items-center justify-between text-xs">
              <div class="flex items-center gap-2.5">
                <i class="fa-solid fa-shield-halved text-purple-600"></i>
                <span class="text-slate-700 font-medium">Security Protocol</span>
              </div>
              <span class="font-mono font-bold text-purple-700">2FA + HMAC-SHA256</span>
            </div>
          </div>
        </div>
        ...
        <div class="lg:col-span-2 p-6 rounded-2xl bg-white border border-slate-200 shadow-xs flex flex-col justify-between">
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <a routerLink="/transactions" class="text-xs font-bold text-indigo-600 hover:text-indigo-700 hover:underline flex items-center gap-1">
            ...
            <table class="w-full text-left text-xs border-collapse">
              ...
              <tbody class="divide-y divide-slate-100 text-slate-900">
                <tr *ngFor="let tx of recentTransactions" class="hover:bg-slate-50 transition-colors">
                  ...
                  <td class="py-3 px-3 text-right text-xs text-slate-400 font-medium">
